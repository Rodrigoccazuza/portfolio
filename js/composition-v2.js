...
(function () {
  ...
  function composeExperience(){
    ...
    const collaborations=section('comp-testimonials',`<p class="comp-eyebrow">Selected collaborations</p><h2>Work made<br><em>with others.</em></h2><p class="comp-collab-intro">A selection of collaborations and projects across client work, brand systems and digital experiences.</p><div class="comp-quotes comp-collab-grid"><article><span class="comp-eyebrow">01 / Brand & campaigns</span><h3>BodyFactory Skin Care</h3><p>Multimedia design, campaign production and marketing systems.</p><a href="${base('projects/brand-systems-bodyfactory/')}">Explore the project ${icon('arrow-up-right')}</a></article><article><span class="comp-eyebrow">02 / Brand & web</span><h3>Prisma Providers</h3><p>Brand identity and responsive web experiences.</p><a href="${base('projects/brand-systems-prisma-providers/')}">Explore the project ${icon('arrow-up-right')}</a></article></div>`);
